...
TOKEN="1926394130:AAHBtB3w2FvTjMCkbGHPiGCjTisLpnryg0Y"
DEVICE="Haydn"
KERVER=$(make kernelversion)
VERSION=v1
DEFCONFIG="haydn_defconfig"
IMAGE=${KERNEL_DIR}/out/arch/arm64/boot/Image
DTBO=${KERNEL_DIR}/out/arch/arm64/boot/dts/vendor/qcom/dtbo.img
...
# Get AnyKernel3
git clone https://github.com/reaPeR1010/AnyKernel3 --depth=1 -b haydn

# Export Vars
KBUILD_BUILD_HOST="ArchLinux"
KBUILD_BUILD_USER="1xAsh"
